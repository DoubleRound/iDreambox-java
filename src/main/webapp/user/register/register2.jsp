...
<body>
	...
	<div class="container">
		<form class="form-signin" id="user_reg_regForm" role="form" method="post">
			...
			<input type="password" name="user.password" class="form-control" placeholder="原密码" required> 
			<input type="password" name="user.repassword" class="form-control" placeholder="新密码" required>
			<input type="password" name="user.repassword" class="form-control" placeholder="确认密码" required>
			<input type="text" name="user.qq" class="form-control" placeholder="QQ" required>
			<input type="radio" name="optionsRadios" value="1" checked required>&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="optionsRadios" value="0" required>&nbsp;女
